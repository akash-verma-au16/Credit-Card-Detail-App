class UI {
    ...
    static flipImage() {
        ...
        document.querySelector('.img-fluid').setAttribute('src', 'img/back.png');
    };
    ...
    static reset() {
        ...
        document.querySelector('.img-fluid').setAttribute('src', 'img/front.png');
    };
};

class Card {
    static cardNumber = '#### #### #### ####';
    static cardHolderName = 'JHON DOE';
    static cvv = '***';
    static year = '01';
    static month = '01';
    ...
    static updateCardHolderName(value) {
        ...
        if(value !== '') document.querySelector('.name-ui').innerText = value;
            else document.querySelector('.name-ui').innerText = 'JHON DOE';
    };
